...
class ValidationTest {
    ...
    void testAdvanceValidate() {
        Address address = new Address("US", "Texas", null, "7", "2");
        Map<String, List<String>> result4 = Validator.advancedValidate(address);
        Map<String, List<String>> expected4 = new HashMap<>();
        expected4.put("country", List.of("length less than 3"));
        expected4.put("street", List.of("can not be null"));
